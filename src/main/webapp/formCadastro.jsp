	...
	<input type="hidden" name="id" value="<%=p.getId()%>">
		<fieldset>
			...
			<img id="img-java" src="img/java.png" alt="imagem java"> <label
				...
				type="text" id="nome" name="nomecompleto"
				placeholder="Digite seu nome completo" value="<%=p.getNome()%>">
			<label for="telefone">Telefone:</label> <input class="larguraTexto"
				type="text" placeholder="(61)9.9999-9999" name="telefone"
				value="<%=p.getTelefone()%>"> <label for="dtNascimento">Data
				de Nascimento:</label> <input class="larguraTexto" type="date"
